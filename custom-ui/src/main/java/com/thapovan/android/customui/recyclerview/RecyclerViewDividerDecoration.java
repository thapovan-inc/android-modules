...
public class RecyclerViewDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public RecyclerViewDividerDecoration(Context context, int orientation,int leftRightMargin) {
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        ...
        if(mLeftRightMargin>0){
            left+=mLeftRightMargin;
            right+=mLeftRightMargin;
        }
